...
# 前端发过来的而数据：商品id商品数目books_id books_count
# 涉及到数据的修改，使用post方式
...
def cart_show(request):
    '''显示用户购物车页面'''
    passport_id = request.session.git('passport_id')
    # 获取用户购物车的记录
    conn = get_redis_connection('default')
...
# 前段传过来的参数：商品id books_id 更新数目 books_count
# post
# /cart/update/
